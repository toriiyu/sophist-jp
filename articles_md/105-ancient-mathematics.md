---
title: "古代の数学と哲学——数と存在の探究"
category: "第2部：古代哲学"
difficulty: 3
keywords: ["ピタゴラス", "プラトン", "アリストテレス", "数論", "存在論"]
excerpt: "古代ギリシャの哲学者たちは、数が宇宙の基本的な構成要素であると考えました。この記事では、ピタゴラス学派からプラトン、そしてアリストテレスまで、数学と哲学の関係性を探究します。"
date: "2026-04-02"
author: "Sophist編集部"
---
